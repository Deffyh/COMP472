...
\title{Automated Footwear Classification} \author{%
	...
	\makebox[\textwidth][c]{%
		...
		Rasel Abdul Samad {\tt\small 40209924}%
	}%
}
\begin{document}
	\maketitle
	...
	\section{Methodology}
	\label{sec:Method}
	Our pipeline utilizes a transfer learning approach to handle the diverse resolutions and backgrounds of the aggregated
