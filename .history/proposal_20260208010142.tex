...
\begin{document}
	...
	listed in Table \ref{tab:dataset} (Footwear 3K, Shoes Classification, and UT Zappos50K) with a total of nine models. These models will be evaluated against two
