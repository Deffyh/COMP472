...
\begin{document}
	...
	\label{sec:Method}
		\subsection{Pipeline}
	Our pipeline focuses comparing zero shot baseline models to those utilizing transfer learning
	...
	Images will be resized to 224 x 224[7] and normalized using ImageNet mean and standard deviation for 
	optimize compatibility with pre-trained weights[8]. A 70/15/15 train/validation/test split will be utilized in order
	to handle class imbalances[9] and prevent overfitting[10]
