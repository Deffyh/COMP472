...
\begin{document}
	...
	utilized in order to prevent overfitting[10]. Real-time augmentations such as horizontal flips, 
	rotations and zooming will be implemented to handle class imbalance and further mitigate overfitting.
% 
