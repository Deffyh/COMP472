...
\begin{document}
	...
	\label{sec:Method}
		\subsection{Pipeline}
	Our pipeline focuses on comparing zero shot baseline models to those utilizing transfer learning
	...
	with a learning rate of $10^-4$[9] and the loss function Categorical Cross-Entropy[10] 
	...
	\subsection{Evolution and Analysis}
	...
	T-SNE for dimensional reduction of latent space[14] and Grad-CAM will serve to vizualize class-discriminative regions
	in at least four of our models. Failure cases will be evaluated with Confusion Matrices[15] to provide
	scientific insights into intra-class variance a common challenge in resilient automated visual search tools.
