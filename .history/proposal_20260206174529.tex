...
\begin{document}
	...
	\section{Methodology}
	\label{sec:Method}
	Our pipeline focuses a mixed approach comparing models designed from scratch to those utilizing transfer learning 
  .All images will be standardized to 224 x 224 pixels and normalized. To prevent overfitting on smaller
