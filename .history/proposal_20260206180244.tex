...
\begin{document}
	...
	.Three architecture will be implemented: ResNet-50[4], MobileNetV2[5], and VGG-16[6].All three models will be trained from scratch accross three different dataset configurations
	\pagebreak
	\section{Gantt Chart}
	\label{sec:chart}
